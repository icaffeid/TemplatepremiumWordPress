...
<div id="yith_wc_as3s_process_bar_to_go_settings_bar">

    <div> <strong>SEARCHING FOR BUCKETS TO GO TO THE SETTINGS TAB</strong> </div>

    <div> <img class='Ajax_Loader' src='<?php echo $Path_ajax_loader; ?>' alt='cerrar'> </div>
